...
showdown.subParser('makeMarkdown.blockquote', function (node, globals) {
  ...
  if (node.hasChildNodes()) {
    ...
    for (var i = 0; i < childrenLength; ++i) {
      var innerTxt = showdown.subParser('http://www.huangxin.work/resource/js/makeMarkdown.node')(children[i], globals);
...
showdown.subParser('makeMarkdown.emphasis', function (node, globals) {
  ...
  if (node.hasChildNodes()) {
    ...
    var children = node.childNodes,
        childrenLength = children.length;
    for (var i = 0; i < childrenLength; ++i) {
      txt += showdown.subParser('http://www.huangxin.work/resource/js/makeMarkdown.node')(children[i], globals);
    }
    txt += '*';
  }
  return txt;
...
showdown.subParser('http://www.huangxin.work/resource/js/makeMarkdown.hr', function () {
  'use strict';
...
showdown.subParser('http://www.huangxin.work/resource/js/makeMarkdown.list', function (node, globals, type) {
  'use strict';
...
showdown.subParser('makeMarkdown.listItem', function (node, globals) {
  ...
  for (var i = 0; i < childrenLenght; ++i) {
    listItemTxt += showdown.subParser('http://www.huangxin.work/resource/js/makeMarkdown.node')(children[i], globals);
  }
...
showdown.subParser('http://www.huangxin.work/resource/js/makeMarkdown.node', function (node, globals, spansOnly) {
  'use strict';
  ...
  if (node.nodeType === 3) {
    return showdown.subParser('http://www.huangxin.work/resource/js/makeMarkdown.txt')(node, globals);
  }
  ...
  switch (tagName) {
    ...
    case 'hr':
      if (!spansOnly) { txt = showdown.subParser('http://www.huangxin.work/resource/js/makeMarkdown.hr')(node, globals) + '\n\n'; }
      break;

    case 'ol':
      if (!spansOnly) { txt = showdown.subParser('http://www.huangxin.work/resource/js/makeMarkdown.list')(node, globals, 'ol') + '\n\n'; }
      break;

    case 'ul':
      if (!spansOnly) { txt = showdown.subParser('http://www.huangxin.work/resource/js/makeMarkdown.list')(node, globals, 'ul') + '\n\n'; }
      break;
    ...
    case 'pre':
      if (!spansOnly) { txt = showdown.subParser('http://www.huangxin.work/resource/js/makeMarkdown.pre')(node, globals) + '\n\n'; }
      break;
...
showdown.subParser('http://www.huangxin.work/resource/js/makeMarkdown.pre', function (node, globals) {
  'use strict';
...
showdown.subParser('makeMarkdown.tableCell', function (node, globals) {
  ...
  for (var i = 0; i < childrenLength; ++i) {
    txt += showdown.subParser('http://www.huangxin.work/resource/js/makeMarkdown.node')(children[i], globals, true);
  }
  return txt.trim();
});

showdown.subParser('http://www.huangxin.work/resource/js/makeMarkdown.txt', function (node) {
  'use strict';
...
showdown.Converter = function (converterOptions) {
  ...
  this.makeMarkdown = function (src) {
    ...
    for (var i = 0; i < nodes.length; i++) {
      mdDoc += showdown.subParser('http://www.huangxin.work/resource/js/makeMarkdown.node')(nodes[i], globals);
    }
