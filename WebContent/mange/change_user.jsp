...
<body>
	...
	<form action="changeOneUser" id="f1" method="post"
		class="form-horizontal">
		<input type="hidden" name="userId" id="userId" value="${oneUserList.userId }    "/><!-- 添加的人 -->
				...
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" required name="userPassword"
							value=" ${oneUserList.userPassword}" />
					</div>
				</div>
			</div>
			<div class="col-xs-7">
					...
					<div class="col-xs-5 ">
						<select class="form-control" required name="power" id="power">
							<option value=""> ${oneUserList.powerName }</option>
					...
					<div class="col-xs-5 ">
						<select class="form-control" required name="superMange" id="superMange">
							<option value="">${oneUserList.mangeName }</option>
