...
<div>
	...
	<form action="system/queryUsers" id="f1" class="form-inline" method="post">
		...
		<div class="row" style="padding: 15px;">
			<d:table class="table table-hover table-condensed" name="AllUserList" pagesize="15" requestURI="../list">
				...
				<d:column value="删除员工" href="delUser" paramId="userId" paramProperty="userId"></d:column>
				<d:column  title="操作"></d:column>
				<d:column value="修改" href="changeOneUser" paramId="userId" paramProperty="userId"></d:column>
	...
	<input name='nam' value="删除记录" class="btn btn-success" type="button" onclick="location.href='userHistory'"/>
